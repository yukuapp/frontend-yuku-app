...
import { parseCollectionStandard_6f12cd52, unwrapCollectionLinks } from '../../types';
import idlFactory from './core_971fd8f8.did';
import {
    _SERVICE,
...
export const parseCollectionInfo = (info: CollectionInfo__1): CollectionInfo => ({
    ...
    royalties: exponentNumber(
        bigint2string(info.royalties.rate),

export default ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        // getAllComponent: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex__1, Component))], ['query']),
        ...
        // getNftHoldInfo: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
        ...
        // setWhiteListPrice: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], [IDL.Bool], []),

export default ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        // clearMintPrice: IDL.Func([], [IDL.Bool], []),
        ...
        // getBurnAccount: IDL.Func([], [IDL.Nat], ['query']),
        ...
        // getRarityScore: IDL.Func([], [IDL.Vec(IDL.Float64)], ['query']),
        ...
        // getWhiteListPrice: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], ['query']),
        ...
        // proBurnAccount: IDL.Func([], [IDL.Bool], []),

export default ({ IDL }) => {
    ...
    // });
    return IDL.Service({
        // add_quota: IDL.Func([IDL.Principal, QuotaType, IDL.Nat32], [BooleanActorResponse], []),
        allowance: IDL.Func([AllowanceRequest], [AllowanceActorResponse], ['query']),
        ...
        // batch_extend_expired_at: IDL.Func(
        //     [IDL.Vec(IDL.Text), IDL.Nat32],
        ...
        //     ['query'],
        // ),
        // ext_tokens_of: IDL.Func([IDL.Principal], [EXTTokensOfResponse], ['query']),
        ...
        getTokens: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat32, Metadata))], ['query']),
        // get_all_details: IDL.Func([GetPageInput], [GetAllDetailsActorResponse], ['query']),
        // get_details: IDL.Func([IDL.Text], [GetDetailsActorResponse], ['query']),
        // get_last_registrations: IDL.Func([], [GetAllDetailsActorResponse], ['query']),
        // get_name_expires: IDL.Func([IDL.Text], [GetNameExpiresActorResponse], ['query']),
        // get_name_status: IDL.Func([IDL.Text], [GetNameStatueActorResponse], ['query']),
        // get_names: IDL.Func([IDL.Principal, GetPageInput], [GetNamesActorResponse], ['query']),
        // get_names_count: IDL.Func([IDL.Principal], [GetNamesCountActorResponse], ['query']),
        // get_owner: IDL.Func([IDL.Text], [GetOwnerActorResponse], ['query']),
        // get_price_table: IDL.Func([], [GetPriceTableResponse], []),
        // get_public_resolver: IDL.Func([], [GetPublicResolverActorResponse], ['query']),
        // get_quota: IDL.Func([IDL.Principal, QuotaType], [GetQuotaActorResponse], ['query']),
        ...
        // import_registrations: IDL.Func([ImportNameRegistrationRequest], [BooleanActorResponse], []),
        // import_token_id_from_registration: IDL.Func([], [ImportTokenIdResponse], []),
        ...
        // register_for: IDL.Func([IDL.Text, IDL.Principal, IDL.Nat64], [BooleanActorResponse], []),
        // register_from_gateway: IDL.Func([IDL.Text, IDL.Principal], [BooleanActorResponse], []),
        // register_with_payment: IDL.Func(
        //     [RegisterNameWithPaymentRequest],
        //     [GetDetailsActorResponse],
        //     [],
        // ),
        // register_with_quota: IDL.Func([IDL.Text, QuotaType], [BooleanActorResponse], []),
        // renew_name: IDL.Func([RenewNameRequest], [BooleanActorResponse], []),
        // run_tasks: IDL.Func([], [BooleanActorResponse], []),
        // sub_quota: IDL.Func([IDL.Principal, QuotaType, IDL.Nat32], [BooleanActorResponse], []),
        // supply: IDL.Func([], [SupplyActorResponse], ['query']),
        // transfer: IDL.Func([IDL.Text, IDL.Principal], [BooleanActorResponse], []),
        // transfer_by_admin: IDL.Func([IDL.Text, IDL.Principal], [BooleanActorResponse], []),
        // transfer_from: IDL.Func([IDL.Text], [BooleanActorResponse], []),
        // transfer_from_quota: IDL.Func([TransferFromQuotaRequest], [BooleanActorResponse], []),
        // transfer_quota: IDL.Func([IDL.Principal, QuotaType, IDL.Nat32], [BooleanActorResponse], []),

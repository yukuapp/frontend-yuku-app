...
export type AllowanceActorResponse = { Ok: bigint } | { Err: CommonError };
...
// export interface BatchAddQuotaRequest {
//     items: Array<ImportQuotaItem>;
// }
// export interface BatchTransferRequest {
//     items: Array<TransferQuotaDetails>;
// }
export type BearerActorResponse = { Ok: string } | { Err: CommonError };
// export type BooleanActorResponse = { Ok: boolean } | { Err: ErrorInfo };
...
//       }
//     | { Err: CommonError };
// export type EXTTokensOfResponse = { Ok: Array<number> } | { Err: CommonError };
export type EXTTransferResponse = { Ok: bigint } | { Err: TransferError };
...
// export type GetAllDetailsActorResponse = { Ok: Array<Registration> } | { Err: ErrorInfo };
// export type GetDetailsActorResponse = { Ok: Registration } | { Err: ErrorInfo };
// export type GetNameExpiresActorResponse = { Ok: bigint } | { Err: ErrorInfo };
// export type GetNameStatueActorResponse = { Ok: NameStatus } | { Err: ErrorInfo };
// export type GetNamesActorResponse = { Ok: GetPageOutput } | { Err: ErrorInfo };
// export type GetNamesCountActorResponse = { Ok: number } | { Err: ErrorInfo };
// export type GetOwnerActorResponse = { Ok: Principal } | { Err: ErrorInfo };
...
// export type GetPublicResolverActorResponse = { Ok: string } | { Err: ErrorInfo };
// export type GetQuotaActorResponse = { Ok: number } | { Err: ErrorInfo };
// export type GetStatsResponse = { Ok: Stats } | { Err: ErrorInfo };
...
//     items: Array<ImportQuotaItem>;
// }
// export type ImportQuotaResponse = { Ok: ImportQuotaStatus } | { Err: ErrorInfo };
// export type ImportQuotaStatus = { Ok: null } | { AlreadyExists: null };
// export type ImportTokenIdResponse = { Ok: bigint } | { Err: ErrorInfo };
export type Metadata = { fungible: Fungible } | { nonfungible: NonFungible };
export type MetadataActorResponse = { Ok: Metadata } | { Err: CommonError };
...
//     state_data: Array<number>;
// }
// export type StateExportResponse = { Ok: StateExportData } | { Err: ErrorInfo };
...
// export type SupplyActorResponse = { Ok: bigint } | { Err: CommonError };
...
export default interface _SERVICE {
    // add_quota: (arg_0: Principal, arg_1: QuotaType, arg_2: number) => Promise<BooleanActorResponse>;
    allowance: (arg_0: AllowanceRequest) => Promise<AllowanceActorResponse>;
    // approve: (arg_0: string, arg_1: Principal) => Promise<BooleanActorResponse>;
    // available: (arg_0: string) => Promise<BooleanActorResponse>;
    // batch_add_quota: (arg_0: BatchAddQuotaRequest) => Promise<BooleanActorResponse>;
    // batch_extend_expired_at: (arg_0: Array<string>, arg_1: number) => Promise<BooleanActorResponse>;
    // batch_transfer_quota: (arg_0: BatchTransferRequest) => Promise<BooleanActorResponse>;
    ...
    // ext_batch_tokens_of: (arg_0: Array<Principal>) => Promise<EXTBatchTokensOfResponse>;
    ...
    // get_all_details: (arg_0: GetPageInput) => Promise<GetAllDetailsActorResponse>;
    ...
    // get_names: (arg_0: Principal, arg_1: GetPageInput) => Promise<GetNamesActorResponse>;
    ...
    // get_quota: (arg_0: Principal, arg_1: QuotaType) => Promise<GetQuotaActorResponse>;
    // get_stats: () => Promise<GetStatsResponse>;
    // get_token_details_by_names: (
    //     arg_0: Array<string>,
    ...
    // import_registrations: (arg_0: ImportNameRegistrationRequest) => Promise<BooleanActorResponse>;
    ...
    // register_for: (arg_0: string, arg_1: Principal, arg_2: bigint) => Promise<BooleanActorResponse>;
    // register_from_gateway: (arg_0: string, arg_1: Principal) => Promise<BooleanActorResponse>;
    // register_with_payment: (
    //     arg_0: RegisterNameWithPaymentRequest,
    // ) => Promise<GetDetailsActorResponse>;
    // register_with_quota: (arg_0: string, arg_1: QuotaType) => Promise<BooleanActorResponse>;
    // renew_name: (arg_0: RenewNameRequest) => Promise<BooleanActorResponse>;
    // run_tasks: () => Promise<BooleanActorResponse>;
    // sub_quota: (arg_0: Principal, arg_1: QuotaType, arg_2: number) => Promise<BooleanActorResponse>;
    // supply: () => Promise<SupplyActorResponse>;
    // transfer: (arg_0: string, arg_1: Principal) => Promise<BooleanActorResponse>;
    // transfer_by_admin: (arg_0: string, arg_1: Principal) => Promise<BooleanActorResponse>;
    // transfer_from: (arg_0: string) => Promise<BooleanActorResponse>;
    // transfer_from_quota: (arg_0: TransferFromQuotaRequest) => Promise<BooleanActorResponse>;
    // transfer_quota: (
    //     arg_0: Principal,
    //     arg_1: QuotaType,
    //     arg_2: number,

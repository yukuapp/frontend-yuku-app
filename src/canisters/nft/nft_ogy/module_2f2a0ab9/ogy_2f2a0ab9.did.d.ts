...
export interface _SERVICE {
    ...
    balance_of_batch_nft_origyn: ActorMethod<[Array<Account>], Array<Result_19>>;
    balance_of_nft_origyn: ActorMethod<[Account], Result_19>;
    balance_of_secure_batch_nft_origyn: ActorMethod<[Array<Account>], Array<Result_19>>;
    ...
    bearer_batch_secure_nft_origyn: ActorMethod<[Array<string>], Array<Result_17>>;
    ...
    collection_update_batch_nft_origyn: ActorMethod<
        ...
        Array<Result_14>
    >;
    collection_update_nft_origyn: ActorMethod<[ManageCollectionCommand], Result_14>;
    ...
    dip721_metadata: ActorMethod<[], Metadata__1>;
    dip721_name: ActorMethod<[], [] | [string]>;
    dip721_operator_token_identifiers: ActorMethod<[Principal], Metadata_1>;
    dip721_operator_token_metadata: ActorMethod<[Principal], Metadata_2>;
    dip721_owner_of: ActorMethod<[bigint], OwnerOfResponse>;
    dip721_owner_token_identifiers: ActorMethod<[Principal], Metadata_1>;
    dip721_owner_token_metadata: ActorMethod<[Principal], Metadata_2>;
    ...
    dip721_token_metadata: ActorMethod<[bigint], Metadata_3>;
    dip721_total_supply: ActorMethod<[], bigint>;
    dip721_total_transactions: ActorMethod<[], bigint>;
    dip721_transfer: ActorMethod<[Principal, bigint], Result__1>;
    dip721_transfer_from: ActorMethod<[Principal, Principal, bigint], Result__1>;
    ...
    history_batch_secure_nft_origyn: ActorMethod<
        ...
        Array<Result_12>
    >;
    history_nft_origyn: ActorMethod<[string, [] | [bigint], [] | [bigint]], Result_12>;
    history_secure_nft_origyn: ActorMethod<[string, [] | [bigint], [] | [bigint]], Result_12>;
    ...
    market_transfer_batch_nft_origyn: ActorMethod<[Array<MarketTransferRequest>], Array<Result_10>>;
    market_transfer_nft_origyn: ActorMethod<[MarketTransferRequest], Result_10>;
    metadata: ActorMethod<[], Metadata__1>;
    metadataExt: ActorMethod<[TokenIdentifier], Result_9>;
    mint_batch_nft_origyn: ActorMethod<[Array<[string, Account]>], Array<Result_3>>;
    ...
    operaterTokenMetadata: ActorMethod<[Principal], Metadata_2>;
    ownerOf: ActorMethod<[bigint], OwnerOfResponse>;
    ownerTokenMetadata: ActorMethod<[Principal], Metadata_2>;
    sale_batch_nft_origyn: ActorMethod<[Array<ManageSaleRequest>], Array<Result_6>>;
    sale_info_batch_nft_origyn: ActorMethod<[Array<SaleInfoRequest>], Array<Result_7>>;
    sale_info_batch_secure_nft_origyn: ActorMethod<[Array<SaleInfoRequest>], Array<Result_7>>;
    ...
    stage_batch_nft_origyn: ActorMethod<[Array<{ metadata: CandyValue }>], Array<Result_3>>;
    stage_library_batch_nft_origyn: ActorMethod<[Array<StageChunkArg>], Array<Result_4>>;

...
import { unwrapOption, unwrapOptionMap, wrapOptionMap } from '@/common/types/options';
    ...
    return list.map((d, index) => {
        ...
        listing_data.listing = unwrapVariant1Map<AuctionStateShared, NftListing>(
            ...
            [
                'auction',
                (a) =>
                    parseOgyAuctionToNftListing_243d1642(current_sale.sale_id, a, yuku_ogy_broker),
            ],
        );
        return listing_data;
    });

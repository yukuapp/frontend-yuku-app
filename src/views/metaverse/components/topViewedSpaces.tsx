        ...
        <div>
            <div className="relative mt-[20px] w-full pb-[40px] pt-[50px] md:pb-0">
                <div className="mx-auto w-full max-w-[1920px] px-[20px] lg:px-[40px]">
                    ...
                    {/* <div className="mt-[20px] flex w-full gap-x-[15px] gap-y-[15px] overflow-x-scroll md:mt-[50px] lg:grid-cols-3 xl:grid xl:grid-cols-4">
                        {spacesList.map((_, index) => (
                            <SpaceCard key={index} info={_} index={index} />
                        ))}
                    </div> */}
